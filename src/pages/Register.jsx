                ...
                <div className="col body border-body">
                    ...
                    <form onSubmit={registerHandler}>
                        <div className="form mb-3">
                            <input type="text" name='username' className="form-control" id="floatingUsername" placeholder="username" onChange={(e) => setUsername(e.target.value)} />
                        </div>
                        <div className="form mb-3">
                            <input type="text" name='firstname' className="form-control" id="floatingFirstname" placeholder="first name" onChange={(e) => setFirstname(e.target.value)} />
                        </div>
                        <div className="form mb-3">
                            <input type="text" name='lastname' className="form-control" id="floatingLastname" placeholder="last name" onChange={(e) => setLastname(e.target.value)} />
                        </div>
                        <div className="form mb-3">
                    ...
                    <div className="row">
                        <span className='whiteColor topSpacing'>Already Having an account?</span>
                        <Link to={'/login'}>
